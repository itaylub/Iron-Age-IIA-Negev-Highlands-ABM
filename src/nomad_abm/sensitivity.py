...
Variant of :mod:`nomad_abm.model` used for sensitivity analysis.
Supports variable agent counts and fixed-territory modes.
``Code/model_opt_sensitivity.py`` is a backwards-compatibility shim that
