...
*Two Zenodo archives: the **software** (this code) and the **input data**.*
...
([10.5281/zenodo.21336898](https://doi.org/10.5281/zenodo.21336898)); the
input-data archive has its own DOI
